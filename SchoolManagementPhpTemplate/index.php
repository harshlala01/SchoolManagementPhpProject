...
// print_r($rows);
      ...
      if($num > 0){
       ...
       // echo $_SESSION['Id'];die();
        ...
        // $_SESSION['admissionNumber'] = $rows['emailAddress'];
        $_SESSION['classId'] = $rows['classId'];
        $_SESSION['className'] = $rows['className'];
        $_SESSION['classArmName'] = $rows['classArmName'];
        $_SESSION['classSecId'] = $rows['classSecId'];
        $_SESSION['session'] = $rows['session'];
        $_SESSION['admissionType'] = $rows['admissionType'];
        $_SESSION['admissionConcessionType'] = $rows['admissionConcessionType'];
        $_SESSION['monthlyConcessionType'] = $rows['monthlyConcessionType'];
