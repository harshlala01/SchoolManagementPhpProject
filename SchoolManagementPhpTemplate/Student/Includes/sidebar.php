        ...
        <li class="nav-item">
          ...
          <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="idcardView.php">ID Card</a>
              <a class="collapse-item" href="studentMarksheet.php">Student Marksheet</a>
               <a class="collapse-item" href="viewAttendance.php">Student Attendance</a>
                  <a class="collapse-item" href="viewStudentAttendance.php">Student Class Attendance</a>
              <!-- <a class="collapse-item" href="idcardView.php?regId=<?php echo $regId; ?>">Id Card</a> -->
