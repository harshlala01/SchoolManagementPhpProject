...
// $pdf->Ln($rowHeight);
        ...
        // $paid_amount = floatval($data['amount_paying']);
        // $paid_amount = isset($data['amount_paying']) ? floatval($data['amount_paying']) : 0;
        // $paid_amount = floatval($data['amount_paying']);


        // $due_amount = $base_amount - $paid_amount;

        // Get latest payment info from `payments` table for regId and type = Books/Uniform
