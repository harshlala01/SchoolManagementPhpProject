    ...
    class PDF extends tFPDF {
        ...
        // }
        function Header() {
    $this->Image('./img/logo/schoolLogo.png', 10, 10, 30); // Left-aligned logo
    ...
    // $pdf->Ln(4);
    // Logo on top-left
$pdf->Image('./img/logo/schoolLogo.png', 10, 7, 30); // x=10, y=10, width=30

// $photoPath = $data['photo'] ?? '../Student/'; // fallback photo if not present
// $pdf->Image($photoPath, 170, 7, 30);
...
$pdf->Cell(63, 7, 'Sign. of Class Teacher', 0, 1, 'C');
    ...
    ob_end_clean();
    $pdf->Output('I', 'Final_Report_Card.pdf');
