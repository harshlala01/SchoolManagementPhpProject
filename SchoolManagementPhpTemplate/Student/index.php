...
// if (!isset($_SESSION['studentName']) || !isset($_SESSION['classId']) || !isset($_SESSION['classSecId'])) {
//     // Redirect to login page ya error dikhao
//     echo "<div class='alert alert-danger'>Session expired or not set. Please login again.</div>";
//     exit;
// }
...
$query1=mysqli_query($conn,"SELECT * from tblattendance where classId = '$_SESSION[classId]' and classSecId  = '$_SESSION[classSecId]'");                       
