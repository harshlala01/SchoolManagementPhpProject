  ...
  <div class="card-body">
    <div class="form-group row mb-3">
      ...
      <div class="col-xl-6"
           ...
           style="border: 2px dashed #007bff; padding: 20px; border-radius: 10px; background-color: #f9f9f9;">
        ...
        <?php if (!empty($row['teacherPhoto'])): ?>
          <small class="mt-2 d-block">Current:
            <a href="uploads/<?php echo htmlspecialchars($row['teacherPhoto']); ?>" target="_blank">View</a>
          </small>
        <?php endif; ?>
      </div>
        ...
        <div class="card" style="padding: 10px; border-radius: 12px; box-shadow: 0 2px 6px rgba(0,0,0,0.1); border: 1px solid #ccc; width: fit-content; background-color: #fff;">
          <div class="card-body p-0 d-flex justify-content-center align-items-center">
            <img id="teacherPhotoPreview"
                 src="img/logo/receipt image.png"
                 alt="Teacher Photo Preview"
                 style="width: 150px; height: 150px; border: 2px solid #ccc; border-radius: 10px; object-fit: cover;">
          </div>
        </div>
      </div>
    </div>
