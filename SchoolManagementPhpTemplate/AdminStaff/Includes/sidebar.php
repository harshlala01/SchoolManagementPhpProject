      ...
      <li class="nav-item">
          ...
          <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item" href="studentPromote.php">Student Promote</a>
                  ...
                  <a class="collapse-item" href="attendanceAnalysis.php">Attendance Analysis</a>
                  <a class="collapse-item" href="defaulterList.php">Defaulter List</a>
