...
// foreach ($regIds as $index => $regId) {
//     $status = $statuses[$index];

//     // Insert into tblattendance
//     $insertQuery = "INSERT INTO tblattendance (admissionNo, classId, classArmId, status, dateTimeTaken) 
//                     VALUES ('$regId', '$classId', '$classArmId', '$status', '$dateTaken')";
